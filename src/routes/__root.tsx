  ...
  head: () => ({
    meta: [
      ...
      { title: "Homeofirst — Homeopathy Clinic in Hajipur · Dr. Paramjeet Prabhakar" },
      {
        name: "description",
        content:
          "Homeofirst is a trusted homeopathy clinic in Hajipur, Bihar led by Dr. Paramjeet Prabhakar — 26+ years of experience, 2 lakh+ patients treated.",
      },
      { name: "author", content: "Homeofirst" },
      { name: "theme-color", content: "#3b5d4a" },
      { property: "og:title", content: "Homeofirst — Homeopathy Clinic in Hajipur" },
      {
        property: "og:description",
        content:
          "Gentle homeopathy. Lasting healing. 26+ years of experience under Dr. Paramjeet Prabhakar.",
      },
