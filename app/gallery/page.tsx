...
import { Activity, Camera, Video, X, Maximize2 } from "lucide-react";
import drImg from "@/public/assets/dr-paramjeet.jpg";
import slide1 from "@/public/assets/Hero Section Slide Show Image 1.jpg";
import slide2 from "@/public/assets/Hero Section Slide Show Image 2.jpg";
import slide3 from "@/public/assets/Hero Section Slide Show Image  3.jpg";
import slide4 from "@/public/assets/Hero Section Slide Show Image 4.jpg";
import slide5 from "@/public/assets/Hero Section Slide Show Image 5.jpg";
import slide6 from "@/public/assets/Hero Section Slide Show Image 6.jpg";
          ...
          {(filter === "all" || filter === "photos") && (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
               {PHOTOS.map((photo) => (
                 ...
                 >
                    <Image src={photo.img} alt={photo.alt} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110" />
