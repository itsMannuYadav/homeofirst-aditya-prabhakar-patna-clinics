    ...
    <>
      ...
      <section className="py-20">
        <div className="container-page grid gap-12 lg:grid-cols-2">
          <div>
            <h3 className="text-3xl">Approach to care</h3>
          ...
          <div>
            <h3 className="text-3xl">Areas of focus</h3>
            <span className="leaf-divider mt-3" />
        ...
        <div className="container-page grid gap-12 lg:grid-cols-2">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-4xl bg-ink shadow-glow">
              <video
                src="/assets/kapil dev award.mp4"
                className="h-full w-full object-cover"
                controls
                muted
                loop
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-4xl bg-ink shadow-glow">
              <video
                src="/assets/zee news interview.mp4"
                className="h-full w-full object-cover"
                controls
                muted
                loop
            ...
            {TIMELINE.map((t, i) => (
              <div key={t.year} className="relative grid grid-cols-[80px_1fr] gap-6 pb-8">
                <div className="text-right">
                  <div className="text-xl text-primary">{t.year}</div>
                </div>
      ...
      <section className="container-page mt-10 pb-20 font-inter">
        <div className="rounded-4xl bg-primary px-8 py-10 text-center text-primary-foreground md:px-16">
          <div className="mt-4 space-y-4 mx-auto max-w-xl text-primary-foreground/85">
              <p className="font-heading text-3xl md:text-4xl">If you are:</p>
